...
1. Select the **A100 high-RAM** runtime variant in Colab. An A100 with 80 GB VRAM and at least 60 GB of system RAM is recommended.
...
4. The model-loading cell checks VRAM and system RAM automatically. If needed, it switches to slower disk-backed low-memory offloading. This mode needs about 34 GiB free VRAM, 36 GiB available system RAM, and 70 GiB free disk. Set `FORCE_LOW_MEMORY_MODE` in that cell to override automatic selection.
